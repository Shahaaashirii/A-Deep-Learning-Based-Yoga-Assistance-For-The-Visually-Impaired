...
('m5lj609nqk3yc53d5kvpym9wdle0fd2z','eyJsaWQiOiIifQ:1ro0cV:NzQ-evUke-Jz8gYUfihB_ZFsQA21iT4OfxWmoMWB66U','2024-04-06 12:37:07.294569');
...
(11,'user','Male','2024-03-01','/media/20240329%2C201429.jpg','u@gmail.com','123','56',13),
...
(3,'The Cobra Pose','/media/20240225-211148.jpg','/media/20240226-0925231.mp4','The Cobra Pose, or Bhujangasana, begins by lying flat on your stomach with hands placed under shoulders and legs extended, inhaling as you slowly lift your chest off the floor using back muscles while keeping elbows close to your body. Maintain align',''),
...
(6,'Child\'s pose','/media/20240226-093145.jpg','/media/20240226-0931451.mp4','Balasana, also known as Child\'s Pose, is a gentle yoga posture that provides relaxation and stretches the back, hips, thighs, and ankles. To perform Balasana, start by kneeling on the yoga mat, with your big toes touching and knees spread apart sligh',''),
(7,'@123','/media/20240226-094511.jpg','/media/20240226-0945111.mp4','The Warrior Pose, or Virabhadrasana, is a foundational yoga pose that strengthens the legs, arms, and core while improving balance and focus. Begin in a standing position at the top of your mat, then step one foot back into a long stride, keeping you','');

/*Data for the table `myapp_yogatips` */

insert  into `myapp_yogatips`(`id`,`title`,`description`,`audiodescription`) values 
(4,'The Cobra Pose','For a successful Cobra Pose, focus on lifting the chest using back muscles, keep elbows close to the body, and breathe deeply to maintain relaxation and stability throughout the pose.',''),
(5,'Mountain pose','Cultivate and maintain a balance of effort and ease. Align your ears, neck, shoulders, and hips above your ankles. Imagine a line of energy extending from your feet through your legs and spine and out through the crown of your head.',''),
(6,'Child\'s pose','Focus on deep, steady breathing to relax fully into Child\'s Pose. Release tension with each exhale. Modify with props like a bolster for added comfort. Respect your body\'s limits and avoid overexertion.',''),
(7,'Warrior pose','For Warrior Pose in yoga, ensure proper alignment by keeping your front knee directly above your ankle and your back leg straight. Engage your core for stability and lift through your chest while reaching your arms overhead. Maintain steady breathing','');
